...
export const GLSL_FILTER_TOGGLE_CONFIG = {
  ...
  styleId: 'w95-glsl-filter-styles',
  targetSelector: 'body',
  retryInterval: TOOLBAR_BUTTON_CONFIG.retryInterval,
  maxRetries: TOOLBAR_BUTTON_CONFIG.maxRetries,
  filters: [
    ...
    },
    {
      name: '暖色',
      icon: 'ti ti-photo',
      cssFilter: 'sepia(0.3) hue-rotate(20deg) saturate(1.2)',
      description: '暖色调滤镜'
    },
    {
      name: '冷色',
      icon: 'ti ti-photo',
      cssFilter: 'hue-rotate(180deg) saturate(1.1) brightness(1.1)',
      description: '冷色调滤镜'
    },
    {
      name: '高对比',
    ...
    },
    {
      name: '锐化',
      icon: 'ti ti-photo',
      cssFilter: 'contrast(1.3) brightness(1.05)',
      description: '锐化效果'
    },
    {
      name: '霓虹',
    ...
    },
    {
      name: '怀旧',
      icon: 'ti ti-photo',
      cssFilter: 'sepia(0.5) contrast(1.1) brightness(0.95) hue-rotate(-10deg)',
      description: '怀旧风格效果'
    }
  ]
} as const;